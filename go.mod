...
require (
	github.com/GoogleCloudPlatform/k8s-cloud-provider 1.13.0
...
replace (
	...
	github.com/GoogleCloudPlatform/k8s-cloud-provider => github.com/GoogleCloudPlatform/k8s-cloud-provider 1.13.0
