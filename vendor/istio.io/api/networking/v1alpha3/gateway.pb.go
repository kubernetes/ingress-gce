...
func file_networking_v1alpha3_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_networking_v1alpha3_gateway_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_networking_v1alpha3_gateway_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Server); i {
			case 0:
				return &v.state
			case 1:
		...
		file_networking_v1alpha3_gateway_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Port); i {
			case 0:
				return &v.state
			case 1:
		...
		file_networking_v1alpha3_gateway_proto_msgTypes[3].Exporter = func(v any, i int) any {
