...
func file_networking_v1alpha3_service_entry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_networking_v1alpha3_service_entry_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_networking_v1alpha3_service_entry_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_networking_v1alpha3_service_entry_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_networking_v1alpha3_service_entry_proto_msgTypes[3].Exporter = func(v any, i int) any {
