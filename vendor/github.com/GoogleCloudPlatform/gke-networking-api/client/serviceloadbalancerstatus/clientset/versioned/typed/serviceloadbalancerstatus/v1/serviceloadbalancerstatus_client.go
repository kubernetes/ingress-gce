...
import (
	...
	"github.com/GoogleCloudPlatform/gke-networking-api/client/serviceloadbalancerstatus/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type NetworkingV1Interface interface {
	RESTClient() rest.Interface
	ServiceLoadBalancerStatusesGetter
}
...
func (c *NetworkingV1Client) ServiceLoadBalancerStatuses(namespace string) ServiceLoadBalancerStatusInterface {
	return newServiceLoadBalancerStatuses(c, namespace)
}
