...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=gke.googleapis.com, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("managedcertificates"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Gke().V1alpha1().ManagedCertificates().Informer()}, nil
