...
// CreateCloudWithCloud is a helper function to create an instance of Cloud with the
...
func CreateCloudWithCloud(config *CloudConfig, c cloud.Cloud) (*Cloud, error) {
	gceCloud, err := CreateCloud(config)
	if err == nil {
		gceCloud.c = c
	}
	return gceCloud, err
