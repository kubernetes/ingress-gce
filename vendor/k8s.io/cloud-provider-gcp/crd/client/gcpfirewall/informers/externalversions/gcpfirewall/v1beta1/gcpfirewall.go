...
import (
	...
	gcpfirewallv1beta1 "k8s.io/cloud-provider-gcp/crd/apis/gcpfirewall/v1beta1"
	...
	v1beta1 "k8s.io/cloud-provider-gcp/crd/client/gcpfirewall/listers/gcpfirewall/v1beta1"
)
