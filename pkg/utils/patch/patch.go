...
func PatchClusterSliceObjectMetadata(client clustersliceclient.Interface, cs *clusterslice.ClusterSlice, newObjectMetadata metav1.ObjectMeta) error {
	...
	_, err = client.FlagsV1().ClusterSlices(newCS.Namespace).Patch(context.Background(), newCS.Name, types.StrategicMergePatchType, patchBytes, metav1.PatchOptions{})
	return err
}
