...
import (
	...
	"k8s.io/ingress-gce/pkg/l4lbconfig/client/clientset/versioned/scheme"
)
...
func (c *NetworkingV1Client) L4LBConfigs(namespace string) L4LBConfigInterface {
	return newL4LBConfigs(c, namespace)
}
