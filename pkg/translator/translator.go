...
type Translator struct {
	...
	IsL7ILB bool
	// IsL7XLBRegional is true if the Ingress will be translated into an L7
	// Regional XLB (as opposed to a Global XLB).
...
func NewTranslator(isL7ILB, isL7XLBRegional bool, frontendNamer namer.IngressFrontendNamer) *Translator {
	return &Translator{
		IsL7ILB:         isL7ILB,
