...
type CachePolicy struct {
	...
	// will overwrite the TTL set in all responses. The maximum allowed
	// value is
	// 31,622,400s (1 year). Infrequently accessed objects may be evicted
	// from
...
type CachePolicyCacheKeyPolicy struct {
	...
	// or
	// included_query_parameters, not both. '&' and '=' will be percent
	// encoded
	...
	// If true, include query string parameters in the cache key according
	// to
	// included_query_parameters and excluded_query_parameters. If neither
	// is
	...
	// or
	// excluded_query_parameters, not both. '&' and '=' will be percent
	// encoded
	// and not treated as delimiters.
...
type HttpRouteAction struct {
	// Cache policy for this URL Map’s route. Available only for
	// Global
