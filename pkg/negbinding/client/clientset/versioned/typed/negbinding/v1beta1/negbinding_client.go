...
import (
	...
	"k8s.io/ingress-gce/pkg/negbinding/client/clientset/versioned/scheme"
)

type NetworkingV1beta1Interface interface {
	RESTClient() rest.Interface
	NetworkEndpointGroupBindingsGetter
}
...
func (c *NetworkingV1beta1Client) NetworkEndpointGroupBindings(namespace string) NetworkEndpointGroupBindingInterface {
	return newNetworkEndpointGroupBindings(c, namespace)
}
