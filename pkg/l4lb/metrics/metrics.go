...
var (
	...
	l4SyncLatencyILBSpecificMetricLabels = []string{
	...
	l4ILBSyncLatency = prometheus.NewHistogramVec(
		...
		append(l4LBSyncLatencyMetricsLabels, l4SyncLatencyILBSpecificMetricLabels...),
	)
	...
	l4ILBSyncErrorCount = prometheus.NewCounterVec(
		...
		append(l4LBSyncErrorMetricLabels, l4SyncLatencyILBSpecificMetricLabels...),
	)
