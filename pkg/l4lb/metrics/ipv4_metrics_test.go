...
func TestExportNetLBMetric(t *testing.T) {
	...
	newMetrics.SetL4NetLBService("svc-ipv4-deny-firewall", L4ServiceState{
		L4FeaturesServiceLabels: L4FeaturesServiceLabels{Multinetwork: false, StrongSessionAffinity: false, WeightedLBPodsPerNode: false, BackendType: L4BackendTypeInstanceGroup, DenyFirewallFamilies: FirewallIPFamiliesIPv4},
		Status:                  StatusSuccess,
	})
	newMetrics.SetL4NetLBService("svc-dual-stack-denied", L4ServiceState{
		L4FeaturesServiceLabels: L4FeaturesServiceLabels{Multinetwork: false, StrongSessionAffinity: false, WeightedLBPodsPerNode: false, BackendType: L4BackendTypeInstanceGroup, DenyFirewallFamilies: FirewallIPFamiliesDualStack},
		L4DualStackServiceLabels: L4DualStackServiceLabels{
			IPFamilies:     "IPv4",
			IPFamilyPolicy: "SingleStack",
		},
	...
	verifyL4NetLBMetric(t, 2, StatusSuccess, isMultinetwork, disabledStrongSessionAffinity, notWeightedLBPodsPerNode, L4BackendTypeNEG, disabledLogging, FirewallIPFamiliesNone)
	verifyL4NetLBMetric(t, 1, StatusSuccess, notMultinetwork, enabledStrongSessionAffinity, notWeightedLBPodsPerNode, L4BackendTypeNEG, disabledLogging, FirewallIPFamiliesNone)
	verifyL4NetLBMetric(t, 1, StatusSuccess, notMultinetwork, disabledStrongSessionAffinity, isWeightedLBPodsPerNode, L4BackendTypeInstanceGroup, disabledLogging, FirewallIPFamiliesNone)
	verifyL4NetLBMetric(t, 1, StatusUserError, notMultinetwork, enabledStrongSessionAffinity, notWeightedLBPodsPerNode, L4BackendTypeInstanceGroup, disabledLogging, FirewallIPFamiliesNone)
	verifyL4NetLBMetric(t, 2, StatusError, notMultinetwork, disabledStrongSessionAffinity, notWeightedLBPodsPerNode, L4BackendTypeInstanceGroup, disabledLogging, FirewallIPFamiliesNone)
	verifyL4NetLBMetric(t, 1, StatusPersistentError, notMultinetwork, disabledStrongSessionAffinity, notWeightedLBPodsPerNode, L4BackendTypeInstanceGroup, disabledLogging, FirewallIPFamiliesNone)
	verifyL4NetLBMetric(t, 1, StatusSuccess, notMultinetwork, disabledStrongSessionAffinity, notWeightedLBPodsPerNode, L4BackendTypeNEG, enabledLogging, FirewallIPFamiliesNone)
	verifyL4NetLBMetric(t, 1, StatusSuccess, notMultinetwork, disabledStrongSessionAffinity, notWeightedLBPodsPerNode, L4BackendTypeInstanceGroup, disabledLogging, FirewallIPFamiliesDualStack)
	verifyL4NetLBMetric(t, 1, StatusSuccess, notMultinetwork, disabledStrongSessionAffinity, notWeightedLBPodsPerNode, L4BackendTypeInstanceGroup, disabledLogging, FirewallIPFamiliesIPv4)
}

func verifyL4NetLBMetric(t *testing.T, expectedCount int, status L4ServiceStatus, multinet string, strongSessionAffinity string, weightedLBPodsPerNode string, backendType L4BackendType, loggingEnabled string, denyFirewalls FirewallIPFamilies) {
...
func TestMetricsWithProtocol(t *testing.T) {
	...
	for protocol, want := range wants {
		...
		t.Run(fmt.Sprintf("NetLB %q", protocol), func(t *testing.T) {
			countFloat := testutil.ToFloat64(l4NetLBCount.With(prometheus.Labels{
				l4LabelProtocol: string(protocol),
				/* we test those above */ l4LabelStatus: string(StatusError), l4LabelMultinet: "false", l4LabelStrongSessionAffinity: "false", l4LabelWeightedLBPodsPerNode: "false", l4LabelBackendType: string(L4BackendTypeInstanceGroup), l4LabelLoggingEnabled: "false", labelDenyFirewall: string(FirewallIPFamiliesNone),
			}))
			actual := int(math.Round(countFloat))
			if want != actual {
				t.Errorf("expected value %d but got %d for protocol: %q", want, actual, protocol)
