...
var (
	...
	degradedModeCorrectnessLabel = []string{
...
func PublishDegradedModeCorrectnessMetrics(count int, endpointType string) {
	DegradeModeCorrectness.WithLabelValues(endpointType).Observe(float64(count))
}
