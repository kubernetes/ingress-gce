...
type NegSyncerKey struct {
	...
	// L4LBType is the type of the L4 LB - internal or external.
	// Syncers for these LB types are different so need to separate key for them.
	// This value should be empty for non L4 syncers.
	L4LBType L4LBType
}
