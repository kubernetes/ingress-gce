...
func (svc *Service) IPv4AddressAnnotation(cloud *gce.Cloud) (string, string, error) {
...
func (svc *Service) IPv6AddressAnnotation(cloud *gce.Cloud) (string, string, error) {
...
func ipAddressFromAnnotation(svc *Service, cloud *gce.Cloud, ipVersion string) (string, string, error) {
