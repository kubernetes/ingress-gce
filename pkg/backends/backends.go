...
// higherPrecedenceAPIVersion returns the higher version based on precedence.
func higherPrecedenceAPIVersion(a, b meta.Version) meta.Version {
...
func (p *Pool) EnsureL4BackendService(params L4BackendServiceParams, beLogger klog.Logger) (*composite.BackendService, utils.ResourceSyncStatus, error) {
	...
	if currentBS == nil {
		...
		expectedBS.Version = higherPrecedenceAPIVersion(currentVersion, expectedBS.Version)
	}
