...
import (
	...
	"k8s.io/ingress-gce/pkg/negcontrollerconfig/client/clientset/versioned/scheme"
)

type NetworkingV1beta1Interface interface {
	RESTClient() rest.Interface
	NEGControllerConfigsGetter
}
...
func (c *NetworkingV1beta1Client) NEGControllerConfigs(namespace string) NEGControllerConfigInterface {
	return newNEGControllerConfigs(c, namespace)
}
