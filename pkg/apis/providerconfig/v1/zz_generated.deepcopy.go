...
func (in *PrincipalInfo) DeepCopyInto(out *PrincipalInfo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrincipalInfo.
func (in *PrincipalInfo) DeepCopy() *PrincipalInfo {
	if in == nil {
		return nil
	}
	out := new(PrincipalInfo)
	in.DeepCopyInto(out)
	return out
}
