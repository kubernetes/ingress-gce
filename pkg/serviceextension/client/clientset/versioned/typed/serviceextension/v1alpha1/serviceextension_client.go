...
import (
	...
	"k8s.io/ingress-gce/pkg/serviceextension/client/clientset/versioned/scheme"
)

type CloudV1alpha1Interface interface {
	RESTClient() rest.Interface
	ServiceExtensionsGetter
}
...
func (c *CloudV1alpha1Client) ServiceExtensions(namespace string) ServiceExtensionInterface {
	return newServiceExtensions(c, namespace)
}
