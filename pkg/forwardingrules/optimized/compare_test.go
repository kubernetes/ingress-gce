...
func TestCompare(t *testing.T) {
	...
	for _, tC := range testCases {
		...
		t.Run(tC.desc, func(t *testing.T) {
			...
			sortFROpts := cmpopts.SortSlices(func(a, b *composite.ForwardingRule) bool { return a.Name < b.Name })
			sortDeleteOpts := cmpopts.SortSlices(func(a, b string) bool { return a < b })
			if diff := cmp.Diff(ops, tC.wantCalls, sortFROpts, sortDeleteOpts); diff != "" {
