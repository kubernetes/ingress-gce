...
func newL4ILBServiceState(globalAccess, customSubnet, inSuccess bool) L4ServiceState {
	return L4ServiceState{
		Metrics: map[string]bool{
			EnabledGlobalAccessKey: globalAccess,
			EnabledCustomSubnetKey: customSubnet,
