...
func Validate(kubeClient kubernetes.Interface, beConfig *v1beta1.BackendConfig) error {
	if beConfig == nil {
		return nil
	}
...
func validateIAP(kubeClient kubernetes.Interface, beConfig *v1beta1.BackendConfig) error {
...
func validateSessionAffinity(kubeClient kubernetes.Interface, beConfig *v1beta1.BackendConfig) error {
