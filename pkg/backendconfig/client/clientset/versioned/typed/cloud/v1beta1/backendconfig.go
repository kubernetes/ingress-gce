...
type BackendConfigInterface interface {
	Create(*v1beta1.BackendConfig) (*v1beta1.BackendConfig, error)
	Update(*v1beta1.BackendConfig) (*v1beta1.BackendConfig, error)
	UpdateStatus(*v1beta1.BackendConfig) (*v1beta1.BackendConfig, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.BackendConfig, error)
	List(opts v1.ListOptions) (*v1beta1.BackendConfigList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.BackendConfig, err error)
...
func (c *backendConfigs) Get(name string, options v1.GetOptions) (result *v1beta1.BackendConfig, err error) {
...
func (c *backendConfigs) List(opts v1.ListOptions) (result *v1beta1.BackendConfigList, err error) {
...
func (c *backendConfigs) Create(backendConfig *v1beta1.BackendConfig) (result *v1beta1.BackendConfig, err error) {
	result = &v1beta1.BackendConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("backendconfigs").
...
func (c *backendConfigs) Update(backendConfig *v1beta1.BackendConfig) (result *v1beta1.BackendConfig, err error) {
	result = &v1beta1.BackendConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backendconfigs").
...
func (c *backendConfigs) UpdateStatus(backendConfig *v1beta1.BackendConfig) (result *v1beta1.BackendConfig, err error) {
	result = &v1beta1.BackendConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("backendconfigs").
...
func (c *backendConfigs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.BackendConfig, err error) {
	result = &v1beta1.BackendConfig{}
