...
import (
	...
	backendconfig_v1alpha1 "k8s.io/ingress-gce/pkg/apis/backendconfig/v1alpha1"
	...
	v1alpha1 "k8s.io/ingress-gce/pkg/backendconfig/client/listers/backendconfig/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudV1alpha1().BackendConfigs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudV1alpha1().BackendConfigs(namespace).Watch(options)
			},
		},
		&backendconfig_v1alpha1.BackendConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backendConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&backendconfig_v1alpha1.BackendConfig{}, f.defaultInformer)
}
