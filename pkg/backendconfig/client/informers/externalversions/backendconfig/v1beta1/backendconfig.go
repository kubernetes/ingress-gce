...
import (
	...
	backendconfig_v1beta1 "k8s.io/ingress-gce/pkg/apis/backendconfig/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudV1beta1().BackendConfigs(namespace).List(options)
			},
		...
		&backendconfig_v1beta1.BackendConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backendConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&backendconfig_v1beta1.BackendConfig{}, f.defaultInformer)
}
