...
import (
	...
	v1 "k8s.io/ingress-gce/pkg/backendconfig/client/listers/backendconfig/v1"
)
...
func (f *backendConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&backendconfigv1.BackendConfig{}, f.defaultInformer)
}

func (f *backendConfigInformer) Lister() v1.BackendConfigLister {
	return v1.NewBackendConfigLister(f.Informer().GetIndexer())
}
