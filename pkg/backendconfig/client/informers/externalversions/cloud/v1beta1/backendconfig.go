...
import (
	...
	cloud_v1beta1 "k8s.io/ingress-gce/pkg/apis/cloud/v1beta1"
...
func (f *backendConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloud_v1beta1.BackendConfig{}, f.defaultInformer)
}
