...
func IPv4ToUse(cloud *gce.Cloud, recorder record.EventRecorder, svc *v1.Service, fwdRule *composite.ForwardingRule, requestedSubnet string) (string, string, error) {
...
//     reset the IP (by returning empty string).
func IPv6ToUse(cloud *gce.Cloud, svc *v1.Service, ipv6FwdRule *composite.ForwardingRule, requestedSubnet string, logger klog.Logger) (string, string, error) {
	// Get value from new annotation which support both IPv4 and IPv6
