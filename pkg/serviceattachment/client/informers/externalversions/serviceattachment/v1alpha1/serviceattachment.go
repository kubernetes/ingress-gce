...
import (
	...
	serviceattachmentv1alpha1 "k8s.io/ingress-gce/pkg/apis/serviceattachment/v1alpha1"
	...
	v1alpha1 "k8s.io/ingress-gce/pkg/serviceattachment/client/listers/serviceattachment/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1alpha1().ServiceAttachments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1alpha1().ServiceAttachments(namespace).Watch(context.TODO(), options)
			},
		},
		&serviceattachmentv1alpha1.ServiceAttachment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceAttachmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&serviceattachmentv1alpha1.ServiceAttachment{}, f.defaultInformer)
}

func (f *serviceAttachmentInformer) Lister() v1alpha1.ServiceAttachmentLister {
	return v1alpha1.NewServiceAttachmentLister(f.Informer().GetIndexer())
}
