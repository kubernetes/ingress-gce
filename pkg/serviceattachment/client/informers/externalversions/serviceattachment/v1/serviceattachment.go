...
import (
	...
	v1 "k8s.io/ingress-gce/pkg/serviceattachment/client/listers/serviceattachment/v1"
)
...
type ServiceAttachmentInformer interface {
	...
	Lister() v1.ServiceAttachmentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkingV1().ServiceAttachments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkingV1().ServiceAttachments(namespace).Watch(context.TODO(), options)
			},
		},
		&serviceattachmentv1.ServiceAttachment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceAttachmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&serviceattachmentv1.ServiceAttachment{}, f.defaultInformer)
}

func (f *serviceAttachmentInformer) Lister() v1.ServiceAttachmentLister {
	return v1.NewServiceAttachmentLister(f.Informer().GetIndexer())
}
