...
func newServiceAttachments(c *NetworkingV1alpha1Client, namespace string) *serviceAttachments {
...
func (c *serviceAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServiceAttachment, err error) {
	result = &v1alpha1.ServiceAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *serviceAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServiceAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServiceAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceattachments").
...
func (c *serviceAttachments) Create(ctx context.Context, serviceAttachment *v1alpha1.ServiceAttachment, opts v1.CreateOptions) (result *v1alpha1.ServiceAttachment, err error) {
	result = &v1alpha1.ServiceAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceattachments").
...
func (c *serviceAttachments) Update(ctx context.Context, serviceAttachment *v1alpha1.ServiceAttachment, opts v1.UpdateOptions) (result *v1alpha1.ServiceAttachment, err error) {
	result = &v1alpha1.ServiceAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceattachments").
...
func (c *serviceAttachments) UpdateStatus(ctx context.Context, serviceAttachment *v1alpha1.ServiceAttachment, opts v1.UpdateOptions) (result *v1alpha1.ServiceAttachment, err error) {
	result = &v1alpha1.ServiceAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceattachments").
...
func (c *serviceAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServiceAttachment, err error) {
	result = &v1alpha1.ServiceAttachment{}
