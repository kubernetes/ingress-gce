...
import (
	...
	"k8s.io/ingress-gce/pkg/serviceattachment/client/clientset/versioned/scheme"
)
...
func (c *NetworkingV1alpha1Client) ServiceAttachments(namespace string) ServiceAttachmentInterface {
